...
#pragma config(Sensor, in2,    mobileGoal,     sensorPotentiometer)
#pragma config(Sensor, in3,    rightArm,       sensorPotentiometer)
...
#pragma config(Motor,  port6,           mobileGoalMotor, tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port7,           rightFourBar,  tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port8,           leftFourBar,   tmotorVex393_MC29, openLoop)
...
///////////////////////////////////////////////////////////
	createGearBox(leftDT, backLeft);
	createGearBox(rightDT, backRight, frontRight);
	...
	createGearBox(mobile, mobileGoalMotor);
...
///////////////////////////////////////////////////////////
	...
	while(1)
	{
		...
		mobileAngle = convertAngle(SensorValue[mobileGoal], -0.0620689655172414, 136);
		...
		mobileUp = (bool)vexRT[Btn5U];
		mobileDown = (bool)vexRT[Btn5D];
		...
		writeDebugStream("Pot reading is: %d Arm reading is %d\n", SensorValue[mobileGoal], mobileAngle);
		...
		*/
		...
		buttonManipulate(left4Bar, vexRT[Btn7U], vexRT[Btn7D]);
		buttonManipulate(right4Bar, vexRT[Btn7U], vexRT[Btn7D]);
		buttonManipulate(claw, vexRT[Btn6D], vexRT[Btn6U]);
		buttonManipulate(chainArm, vexRT[Btn8U], vexRT[Btn8D]);
		if(vexRT[Btn7L] || vexRT[Btn7R])
		{
			buttonManipulate(mobile, vexRT[Btn7L], vexRT[Btn7R]);
		}
		else
		{
